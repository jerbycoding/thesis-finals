...
*   **Feedback:** After completion, use `TerminalSystem.inject_system_message()` to display the number of logs successfully removed (using the Array return from `LogSystem.prune_logs_for_host()`).
*   **Failure Path:**
