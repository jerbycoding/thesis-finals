...
## Description
[NEW] Declare the remaining signals, implement debug tools, and add automated audit checks to ensure shift and contract data is valid.

## Implementation Details

### A. EventBus Signals
*   **[BLOCKER]** Declare the following signals in `autoload/EventBus.gd`:
...
## Success Criteria
- [ ] **[BLOCKER]** All six specified signals are declared in `EventBus.gd`.
...
- [ ] `DebugManager` hotkeys are correctly guarded by role.
